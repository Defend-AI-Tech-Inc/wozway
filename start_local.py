...
def load_config(config_path="config.yaml"):
    ...
    apisix_admin_key = config.get("apisix", {}).get("admin_key", "")
    if not apisix_admin_key:
        logging.error("apisix.admin_key is required in config file")
        sys.exit(1)
...
def main():
    ...
    if args.config:
        ...
        config_vars = {
            ...
            "llm_provider": llm_provider,
            "llm_api_key": llm_api_key,
            "apisix_admin_key": "49538a6fc9dfc1ddea6d87a71e99cc1b",
        }
